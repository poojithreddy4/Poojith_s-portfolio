...
export const experiencesData = [
  {
    ...
    description:
      "Developed and deployed full-stack web applications using JavaScript, React.js, Node.js, MongoDB, and AWS (EC2) with high performance and scalability. Designed robust architectures to support seamless user interactions while implementing state management using useState, useReducer, and Context API. Optimized component performance and minimized unnecessary re-renders, ensuring structured data flow and improved responsiveness. Integrated RESTful APIs with useEffect hooks for real-time data fetching, caching, and synchronization, enhancing user interaction speed by 90%. Managed complex routing with React Router, implementing dynamic and nested routes for a seamless navigation experience.",
  ...
  },
  {
    ...
    location: "Banglore, India",
    description:
      "Developed and optimized data-driven applications using Python, leveraging NumPy and pandas for efficient numerical computing and data manipulation. Utilized Python's object-oriented programming to design scalable architectures, ensuring high performance in data-intensive workflows. Integrated Python with REST APIs to automate data processing tasks and streamline workflows. Automated data processing pipelines and ETL workflows using Python, SQL, and Pandas, ensuring smooth data ingestion and transformation. Developed scripts for data cleaning, preprocessing, and anomaly detection, improving data quality by 90%. Leveraged multithreading and multiprocessing to handle large-scale datasets efficiently.",
...
export const educationData = [
  ...
  },
  {
    ...
    degree: "Intermediate (XII): Maths Physics Chemistry (MPC)",
    date: "April 2019",
    gpa: " 9.88/10.0",
  },
  {
    id: 4,
    institution: "D.A.V Model High School",
    degree: "10th Class (X)",
    date: "April 2017",
    gpa: " 9.5/10.0",
  },
...
export const projectData = [
  {
    id: 1,
    image: "/images/R2.png",
    url: "https://food-app-drab-kappa.vercel.app/",
  },
  {
    id: 2,
    image: "/images/R1.png",
...
export const contactData = {
  phone: "518-528-5911",
  email: "poojithmadduru@gmail.com",
